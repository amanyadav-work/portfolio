...
import { FaGitAlt, FaGolang, FaHtml5, FaNode, FaPython } from "react-icons/fa6";
import { FaSquareJs } from "react-icons/fa6";
import { FaDocker, FaJsSquare, FaWordpressSimple } from "react-icons/fa";
import { SiDocker, SiElementor, SiGoland, SiNextdotjs, SiTailwindcss } from "react-icons/si";
...
const PortfolioNavigation = ({ sectionRefs, isMobile }) => {
  ...
  return (
    <>
      {!isMobile && <div className="cursor-circle"></div>}
      <div className="navhome">
        ...
        <div className='navbar-nav ul-nav'>
          ...
          <a className='nav-link rotate-link pl-2 pr-2' target='_blank' href="/resume" style={{ marginTop: "-13px" }}>CV<MdArrowOutward /></a>
        </div>
          ...
          >
            ...
            <div className="hero-container hero-container-new" bis_skin_checked="1">
              <div className="hero-content hero-content-new" bis_skin_checked="1">
                ...
                <div className="hero-text-new d-flex">
                  <div className='d-flex gap-3'>
                    <SiNextdotjs className='icon-blur' />
                    <FaDocker className='icon-blur' />
                    <FaGitAlt className='icon-blur' />
                  </div>
                  <div className='d-flex gap-3'>
                    <FaPython className='icon-blur' />
                    <FaGolang className='icon-blur' />
                    <CgFigma className='icon-blur' />
                  </div>
                  <div className='d-flex gap-3'>
                    <BiLogoPostgresql className='icon-blur' />
                    <DiMongodb className='icon-blur' />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="d-flex boxs text-light mt-3">
                  <ul className="list-group w-75">
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center text-light edu-li">
                      BCA
                      <span className="badge text-bg-danger rounded-pill">2026</span>
                    </li>

                  </ul>
                  <a href="/resume" target="_blank" className='w-25 d-flex justify-content-center flex-column align-items-center edu-li'><MdDownload className='icon-blur h1' />CV</a>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="p-relative" id="section-3" data-scroll-snap>
          ...
          >
            ...
            <div className="hero-container left-side">
              <div className="hero-content">
                <p className="hero-text" style={{ color: "#9595fc70" }}>
                  A brief snapshot of my journey...
                </p>
                ...
                <p className="hero-text gradient-title1 g-blue opacity-100">
                  Have shipped end-to-end applications, working on frontend interfaces, backend services, third-party integrations, and UI/UX design to deliver complete, production-ready solutions.
                </p>
